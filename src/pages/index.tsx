...
export default function Home() {
  ...
  return (
    <>
      <FractionSwiper>
        <FullScreenImage src="/images/main/1.png" alt="Main Image 1" />
        <FullScreenImage src="/images/main/2.png" alt="Main Image 2" />
        <FullScreenImage src="/images/main/3.png" alt="Main Image 2" />
        <FullScreenImage src="/images/main/4.png" alt="Main Image 2" />
      </FractionSwiper>
