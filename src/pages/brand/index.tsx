            ...
            <div className="text__container">
              ...
              <p className="description fade move animate2">
                {locale === 'en' ? (
                  <>
                    <p>
                      Herbtherapy with Cosmetics has expanded to Uzbekistan
                      under the <br />
                      I&apos;m ORGANIC brand.
                    </p>
                    <ul>
                    ...
                    <p>
                      We are a company that respects the time of nature, and
                      this is fully reflected in I&apos;m Organic products.
                    </p>
                  </>
                ) : locale === 'uz' ? (
                  <>
              ...
              <p className="description center right__margin fade move animate2">
                {locale === 'en' ? (
                  ...
                  <>
                    ...
                    철저히 <br className="mo" />
                    배제하고, <br />
                    자연에서 얻은 최고 품질의 재료들만 사용하여 제품을
                    처방합니다. <br className="mo" />
                    <br />
                    이러한 방식은 피부에 순하면서도 효과적인 제품을 만들어 내는
                    핵심 <br className="mo" />
                    원칙입니다. <br /> 저희는 고객의 피부가 본연의 건강함을
                    되찾고 유지할 수 있도록 돕기 위해 <br />
                    끊임없이 연구하고 노력하겠습니다.
                  </>
                )}
              </p>
            ...
            <div className="description fade move animate1">
              {locale === 'en' ? (
                <>
                  ...
                  gifts with I&apos;m Organic and enjoy radiant days with
                  healthy skin.
                </>
              ) : locale === 'uz' ? (
                <>
                ...
                <>
                  ...
                  피부의 건강과 아름다움을 추구하는 모든 이들과 함께합니다.{' '}
                  <br />
